...
var instrucciones = [
  '1- Usar las flechas para mover las piezas',
  '2- Armar la imagen de referencia que hay a la izquierda',
  '3- Ganar Ganar Ganar!'
];
...
function intercambiarPosicionesGrilla(filaPos1, columnaPos1, filaPos2, columnaPos2) {
  var datoA = grilla[filaPos1][columnaPos1];
  grilla[filaPos1][columnaPos1]= grilla [filaPos2][columnaPos2];
  grilla[filaPos2][columnaPos2] = datoA;
}
